...
git config --global user.name "Joao Bentes"
git config --global user.email "joaobentes.junior@gmail.com"
ssh-keygen -t rsa -N "" -C "joaobentes.junior@gmail.com" -f ~/.ssh/id_rsa
ssh-add .ssh/id_rsa
